          ...
          <div class="col-xl-6 col-lg-8">
             <div class="tp-login-wrapper">
                <div class="tp-login-top text-center mb-30">
                   ...
                   <p>quay lại đăng nhập? <span><a href="{{ route('customer.login.post') }}"> Đăng nhập tài khoản</a></span></p>
                </div>
...
<form action="{{route('customer.password.change')}}" method="POST" class="my-4">
@csrf
                   ...
                   <div class="tp-login-input-wrapper">
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input  id="email" class="form-control @error('email') is-invalid @enderror" type="email" name="email" required placeholder="Nhập email của bạn" value="{{ old('email') }}">
                            @error('email')
                      ...
                      <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input  id="email" class="form-control" type="password" id="password_confirmation" name="password_confirmation" required placeholder="Nhập lại mật khẩu mới">
                       </div>
                        <div class="tp-login-input-title">
