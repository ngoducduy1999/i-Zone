                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <form action="{{ route('admin.updateProfile', $profile->id) }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <input type="text" name="ten" id="ten" class="form-control" value="{{ old('ten', $profile->ten) }}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="email" id="email" class="form-control" value="{{ old('email', $profile->email) }}" placeholder="Email">
                                                                </div>
                                                            </div>
                                                        </div>
