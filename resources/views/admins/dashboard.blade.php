                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="fs-14 mb-1">Lượng truy cập website</div>
                                </div>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="card-title mb-0">Nguồn truy cập tốt nhất</h5>
                        </div>
                    </div>
                            ...
                            <table class="table table-traffic mb-0">
                                <tbody>
                                    <thead>
                                        <tr>
                                            <th>Mạng xã hội</th>
                                            <th colspan="2">Lượng truy cập</th>
                                        </tr>
                                    </thead>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="card-title mb-0">Khán giả theo thời gian trong ngày</h5>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div class="border border-dark rounded-2 me-2 widget-icons-sections">
                                <i data-feather="share" class="widgets-icons"></i>
                            </div>
                            <h5 class="card-title mb-0">Tổng số phiên truy cập mỗi tháng</h5>
                        </div>
                    </div>
                            ...
                            <table class="table table-traffic mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            /home
                                            <a href="#" class="ms-1" aria-label="Mở trang web">
