        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="{{route('admin.mausacs.update',$mausac->id)}}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="trang_thai" id="">
                                        ...
                                        <option value="1" {{ $mausac->trang_thai == '1' ? 'selected' : '' }}>Còn
                                            hàng</option>
                                        <option value="0" {{ $mausac->trang_thai == '0' ? 'selected' : '' }}>Hết
                                            hàng</option>
