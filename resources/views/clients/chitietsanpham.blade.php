 ...
 --}}
                        ...
                        <div class="tp-product-details-price-wrapper mb-20">
                            ...
                            <style>
                                ...
                                .tp-color-variation-btn.selected,
                                .tp-size-variation-btn.selected {
                ...
                <div class="tp-product-details-bottom pb-140">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="tp-product-details-tab-nav tp-tab pt-80">
                                    <nav>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <div class="tp-product-details-desc-banner text-center m-img">
                                                                        <h3 class="text-black">
                                                                            <div class="mo-ta">
                                                                                <!-- Khối nội dung đầy đủ sẽ bị giới hạn bằng CSS -->
                                                                                <div class="noi-dung" id="noiDung">{!! $sanpham->mo_ta !!}</div>
                                                                                
                                                                                <!-- Nút "Xem thêm" -->
                                                                                <button class="btn-xem-them" onclick="toggleMoTa()">Xem thêm </button>
                                                                            </div>
                                                                                                                                                    </h3>
                                                                    </div>
                                                                </div>
...
.noi-dung {
    ...
    overflow: hidden;
    position: relative;
    mask-image: linear-gradient(to bottom, black 60%, transparent 100%); /* Hiệu ứng mờ dần ở đáy */
    transition: max-height 0.3s ease;
}

.mo-ta.mo-ta-day-du .noi-dung {
    max-height: none; /* Mở rộng chiều cao để hiển thị đầy đủ khi bấm "Xem thêm" */
    mask-image: none;
}
                                        ...
                                        <script>
                                            function toggleMoTa() {
                                                ...
                                                moTa.classList.toggle('mo-ta-day-du');
                                            
                                                if (moTa.classList.contains('mo-ta-day-du')) {
                                                    btnXemThem.innerText = 'Thu gọn';
                                                } else {
                                                    btnXemThem.innerText = 'Xem thêm';
                                                }
                                            }
                                            </script>
